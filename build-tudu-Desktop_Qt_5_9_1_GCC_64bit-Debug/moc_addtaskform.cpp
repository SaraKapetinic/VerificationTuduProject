...
#include "../tudu/headers/addtaskform.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_AddTaskForm_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AddTaskForm_t qt_meta_stringdata_AddTaskForm = {
    {
QT_MOC_LITERAL(0, 0, 11) // "AddTaskForm"
...
const QMetaObject AddTaskForm::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AddTaskForm.data,
      qt_meta_data_AddTaskForm,  qt_static_metacall, nullptr, nullptr}
};
...
void *AddTaskForm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AddTaskForm.stringdata0))
